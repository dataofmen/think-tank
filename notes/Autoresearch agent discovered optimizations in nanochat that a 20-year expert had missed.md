...
Related:: [[Autoresearch pattern requires a measurable metric, code access, and experiment history tracking]] — 이 사례가 3요소 패턴의 구체적 실증 근거를 제공
Related:: [[AI agents that use their own capabilities to build new capabilities produce compound improvement effects]] — ~20개 개선의 additive stacking이 compound improvement의 실증 사례
